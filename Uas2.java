...
public class Uas2 {
    ...
    public static void executeGetRequest(String apiKey, String endpoint) {
        try {
            // URL endpoint untuk request GET
            String apiUrl = "https://akademik.stmik-im.ac.id/api/" + endpoint;
            ...
            try (BufferedReader in = new BufferedReader(new InputStreamReader(connection.getInputStream()))) {
                ...
                System.out.println("Response from GET request for " + endpoint + ":");
    ...
    public static void main(String[] args) {
        try {
            ...
            executeGetRequest(apiKey, "list/OrtuDns");
            
            // Melakukan request untuk mendapatkan daftar hadir
            executeGetRequest(apiKey, "list/daftar_hadir");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
